  ...
  return (
    <div className="grid" style={{ gap: 20 }}>
      <section className="panel">
        ...
        <p className="muted">{text("Название и короткое описание заполните на русском и узбекском. В шаблоне есть подсказки, списки значений и примеры услуги, товара и аренды.", "Nomi va qisqa tavsifini rus va o‘zbek tillarida to‘ldiring. Shablonda ko‘rsatmalar, ro‘yxatlar hamda xizmat, mahsulot va ijara misollari bor.")}</p>
      </section>
      <section className="panel">
