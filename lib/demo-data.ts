...
export const categories: ServiceCategory[] = [
  ...
  { id: "cat-costumes", slug: "costumes", name: "Костюмы и реквизит", icon: "✧", section: "services", requiredForWedding: false },
  ...
  { id: "cat-tableware", slug: "tableware", name: "Посуда и сервировка", icon: "◫", section: "market", requiredForWedding: false },
...
const legacySuppliers: Supplier[] = [
  ...
  },
  {
    ...
    verified: false,
    verificationLabel: "Проверка автора предложения не завершена",
  ...
  {
    id: "supplier-zarafshon",
    slug: "zarafshon-marosim",
    name: "Zarafshon Marosim",
    city: "Бухара",
    description: "Камерные площадки, традиционная кухня и музыкальные программы для семейных событий.",
    verified: true,
    verificationLabel: "Компания проверена модератором",
    updatedAt: "2026-09-02T09:00:00+05:00",
    responseMedianMinutes: 48,
    responseSampleSize: 5,
    portfolio: ["Никах и семейный ужин", "Плов на открытой площадке", "Национальная музыка"],
    createdAt: "2026-08-25T10:00:00+05:00",
  },
  {
    id: "supplier-fergana-party",
    slug: "fergana-party",
    name: "Farg‘ona Bayram",
    city: "Фергана",
    description: "Семейные праздники, оформление, ведущие и товары для самостоятельной подготовки.",
    verified: false,
    verificationLabel: "Проверка автора предложения не завершена",
    updatedAt: "2026-09-02T09:00:00+05:00",
    responseMedianMinutes: null,
    responseSampleSize: 2,
    portfolio: ["Семейный дастархан", "Фотозона с шарами", "Детский праздник"],
    createdAt: "2026-08-26T14:20:00+05:00",
  },
  {
    id: "supplier-yuksalish",
    slug: "yuksalish-team",
    name: "Yuksalish Team",
    city: "Ташкент",
    description: "Корпоративные тренинги, командные игры и персонал для деловых мероприятий.",
    verified: true,
    verificationLabel: "Компания и программа проверены",
    updatedAt: "2026-09-02T09:00:00+05:00",
    responseMedianMinutes: 55,
    responseSampleSize: 7,
    portfolio: ["Тренинг руководителей", "Командный квест", "Регистрация конференции"],
    createdAt: "2026-08-24T09:15:00+05:00",
  },
  {
    id: "supplier-prostage",
    slug: "prostage-uz",
    name: "ProStage UZ",
    city: "Ташкент",
    description: "Аренда звука, экранов, света и резервного питания для событий разного масштаба.",
    verified: true,
    verificationLabel: "Компания и оборудование проверены",
    updatedAt: "2026-09-02T09:00:00+05:00",
    responseMedianMinutes: 31,
    responseSampleSize: 9,
    portfolio: ["LED-экран на открытом воздухе", "Звук для 200 гостей", "Комплект для конференции"],
    createdAt: "2026-08-31T17:00:00+05:00",
  },
];
