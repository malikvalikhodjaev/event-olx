...
- Администратор: видит поставщиков, активных пользователей, онлайн, заявки и скорость ответа по периоду; модерирует карточки, блокирует поставщиков с обязательной причиной и видит аудит действий.
