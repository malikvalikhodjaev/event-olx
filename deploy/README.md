...
В production-процессе не используется системный Node.js 18. В каталоге EventHub закреплен собственный проверенный Node.js `22.23.2`, поэтому обновление MVP не влияет на Datfo.
